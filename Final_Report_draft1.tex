...
mount -t dos /dev/hd0t12 /fs/sd
    \end{verbatim}
    \item You will find the scripts to run OTA updates at the bottum of your build file.
...
\textcolor{red}{Table~\ref{tab:summary-results} is the primary benchmark summary table. Final values should be inserted after each version has been run multiple times and averaged bellow inserts are from 1 run each}
\begin{table}[ht]
\centering
\small
...
\toprule
  Verify Time & Total OTA & Avg CPU & Max CPU & Avg RAM & Max RAM & Sig Size \\
  & (s) & (s) & (\%) & (\%) & (MB) & (MB) & (bytes) \\
\midrule
Unsigned & N/A & 7 & 2.5 & 4.5 & 194.75 & 195 & 0 \\
RSA     & 1 & 7 & 3.7 & 4.7 & 194.5 & 195 & 256 \\
ML-DSA  & 2 & 8 & 3.52 & 5.1 & 194 & 194 & 2420 \\
\bottomrule
\end{tabular}
\end{table}
